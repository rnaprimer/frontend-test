...
export default function BuyPage() {
  ...
  return (
    <main className="w-full h-[100dvh] fixed inset-0 bg-white flex flex-col md:flex-row items-center justify-center p-8 overflow-hidden">
      <ExploreNavbar />
      ...
      <div className="flex-1 lg:flex-[0.8] flex flex-col items-center justify-center p-4 mt-8 md:mt-0 md:-translate-x-12 lg:-translate-x-24">
        <button
          ...
          disabled={loading}
          className={`
            relative group w-full max-w-[360px] sm:max-w-[420px] py-4 sm:py-5
